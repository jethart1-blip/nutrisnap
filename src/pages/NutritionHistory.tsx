        ...
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 py-2 rounded-xl text-sm font-semibold transition-colors ${
              viewMode === 'day' ? 'bg-accent text-white' : 'bg-surface2 text-textMuted'
            }`}
          >
            Day
          </button>
          <button
            ...
            className={`flex-1 py-2 rounded-xl text-sm font-semibold transition-colors ${
              viewMode === 'calendar' ? 'bg-accent text-white' : 'bg-surface2 text-textMuted'
            }`}
          >
            Calendar
          </button>
        ...
        {viewMode === 'calendar' ? (
            ...
            <div className="grid grid-cols-7 gap-1">
              {getMonthGrid(calendarMonth).map((date, i) => {
                ...
                const dayTotal = logs
                  ...
                  .reduce((sum, l) => sum + l.confirmed.calories, 0);
          ...
          <>
            ...
            <div className="flex items-center justify-between">
              <button
                onClick={() => changeDay(-1)}
                className="p-2 rounded-full bg-surface active:scale-95 transition-transform"
              >
                <ChevronLeft size={20} />
              </button>
              <h2 className="text-lg font-display font-bold text-textPrimary">
